...
email_names = []                                                          # empty dictionary to store instance names.                     
...
dept_name = input('What information would you like to prepend to the email? ')              # Prompt for department name.              
...
while (num < instances):
    ...
    uniq_name = dept_name + unique_num + unique_char+"@gmail.com"                    # concantenate strings to create unique name
    email_names.append(uniq_name)                                         # Add names to the list.
